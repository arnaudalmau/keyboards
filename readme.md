...
Partially mimicking the legendary KBC Poker in its function layer (arrows in the right shift cluster, F1-F12 in the numbers row, Fn in the AltGr), the finished layout looks like this:
